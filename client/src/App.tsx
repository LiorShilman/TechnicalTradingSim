...
function App() {
  ...
  if (isStartScreen) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark-bg via-blue-950/20 to-purple-950/20 p-4 overflow-y-auto" dir="rtl">
